...
export default function FooterDesktop() {
  return (
    <footer className="py-6 px-10 bg-gray-800 text-gray-50">
            ...
            <div className="flex">
              <div className="mr-4">
                <a href="https://www.apple.com/app-store/">
                  <img
                    style={{ width: 30, borderRadius: "50%" }}
                    src="./img/data_image_png;base… (1).png"
                    alt=""
                  />
                </a>
              </div>
              <div>
                <a href="https://play.google.com/store/apps?hl=en_US&gl=US">
                  <img
                    style={{ width: 30, borderRadius: "50%" }}
                    src="./img/data_image_png;base….png"
                    alt=""
                  />
                </a>
              </div>
      ...
      <div>
        <div>
          <img src="data_image_jpeg;bas… (4).jpg" alt="" />
        </div>
        <div>
        ...
        <div>
          <img src="daThongBao-logo.cb85045e.png" alt="" />
        </div>
      </div>
    </footer>
  );
